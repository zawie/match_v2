function makeAssignments(externships) {
  /*
...
function getUnmatchedExternships(externships) {
  /*
    Inputs: List of Externship objects
...
function getNumberUnmatchedExternships(externships) {
  /*
    Inputs: List of Externship objects
...
function getNumberMatchedExternships(externships) {
  /*
    Inputs: List of Externship objects
...
function getPercentageMatchedHosts(externships) {
  /*
...
function getUnmatchedStudents(students) {
  /*
    Inputs: List of Student objects
...
function getNumberUnmatchedStudents(students) {
  /*
    Inputs: List of Student objects
...
function getPercentageMatchedStudents(students) {
  /*
    Inputs: List of Student objects
...
function getMatchedStudents(students) {
  /*
    Inputs: List of Student objects
...
function getNumberMatchedStudents(students) {
  /*
    Inputs: List of Student objects
...
function getAverageMatchedRank(students) {
  /*
    Inputs: List of Student objects 
...
function getAverageUnmatchedRank(students) {
  /*
    Inputs: List of Student objects 
...
function getStats(students, externships){
  /*
